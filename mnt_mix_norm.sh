...
TASK_NORM="agent_proxy.reward_normalization.grouping=inductive"

LOCAL_PATH="/root/autodl-tmp/mnt-mix-norm"
LOG_DIR="/root/RAGEN/logs/mnt-mix-norm"
...
WANDB_MODE=offline RAY_DEDUP_LOGS=0 python train.py --config-name _19_MNT_mix \
 ...
 trainer.experiment_name=MNT-mix-norm \
 $USE_GRPO $TASK_NORM 2>&1 | tee "$LOG_DIR/grpo_${TIMESTAMP}.log" &
